...
public class ConfigureUniversity {
    ...
    public static UniversityBusiness configure() {
        ...
        UserAccount facultyAccount1 = business.getUserAccountDirectory().newUserAccount("prof1", "password", "FACULTY");
        facultyAccount1.setPerson(p1);
        facultyAccount1.setFacultyProfile(faculty1);
        
        UserAccount facultyAccount2 = business.getUserAccountDirectory().newUserAccount("prof2", "password", "FACULTY");
        facultyAccount2.setPerson(p2);
        facultyAccount2.setFacultyProfile(faculty2);
        
        UserAccount studentAccount1 = business.getUserAccountDirectory().newUserAccount("student1", "password", "STUDENT");
        studentAccount1.setPerson(p3);
        studentAccount1.setStudentProfile(student1);
        
        UserAccount studentAccount2 = business.getUserAccountDirectory().newUserAccount("student2", "password", "STUDENT");
        studentAccount2.setPerson(p4);
        studentAccount2.setStudentProfile(student2);
