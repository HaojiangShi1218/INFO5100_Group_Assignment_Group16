...
public class FacultyWorkAreaJPanel extends JPanel {
    ...
    private void openManageCourses() {
        ManageCoursesJPanel panel = new ManageCoursesJPanel(business, userAccount, cardPanel);
    ...
    private void openViewStudents() {
        ViewStudentsJPanel panel = new ViewStudentsJPanel(business, userAccount, cardPanel);
        cardPanel.add(panel, "viewStudents");
        ((CardLayout) cardPanel.getLayout()).show(cardPanel, "viewStudents");
    }
    
    private void openMyProfile() {
        FacultyProfileJPanel panel = new FacultyProfileJPanel(business, userAccount, cardPanel);
        cardPanel.add(panel, "myProfile");
        ((CardLayout) cardPanel.getLayout()).show(cardPanel, "myProfile");
    }
    
    private void openPerformanceReport() {
        CoursePerformanceReportJPanel panel = new CoursePerformanceReportJPanel(business, userAccount, cardPanel);
    ...
    private void openTuitionInsight() {
        TuitionInsightJPanel panel = new TuitionInsightJPanel(business, userAccount, cardPanel);
