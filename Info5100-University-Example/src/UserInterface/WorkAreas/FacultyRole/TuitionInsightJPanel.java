...
public class TuitionInsightJPanel extends JPanel {
    ...
    public TuitionInsightJPanel(Department department, UserAccount userAccount, JPanel cardPanel) {
    ...
    private void viewCourseDetails() {
        ...
        addDetailRow(contentPanel, "Course Title:", course.getName());
    ...
    private void exportReport() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                writer.write("═══════════════════════════════════════════════════════════════\n\n");
                writer.write("Instructor: " + userAccount.getUserLoginName() + "\n");
