...
public class FacultyProfileJPanel extends JPanel {
    ...
    public FacultyProfileJPanel(Department department, UserAccount userAccount, JPanel cardPanel) {
    ...
    private void loadProfileData() {
        ...
        if (faculty != null) {
            ...
            courseCountLabel.setText(String.valueOf(assignmentSize));
            ...
            for (FacultyAssignment fa : assignments) {
                ...
                String title = fa.getCourseoffer().getSubjectCourse().getName();
    ...
    private void editProfile() {
        ...
        JTextField usernameField = new JTextField(userAccount.getUserLoginName(), 20);
