...
public class ViewStudentsJPanel extends JPanel {
    ...
    public ViewStudentsJPanel(Department department, UserAccount userAccount, JPanel cardPanel) {
    ...
    private void showTranscriptDialog(Seat seat, CourseOffer courseOffer) {
        ...
        JLabel headerLabel = new JLabel("Student ID: " + student.getPerson().getPersonId());
    ...
    private void showGradingDialog(Seat seat, CourseOffer courseOffer) {
        ...
        headerPanel.setBorder(BorderFactory.createEmptyBorder(15, 15, 15, 15));
        JLabel headerLabel = new JLabel("Grade Student: " + student.getPerson().getPersonId());
        headerLabel.setFont(new Font("Arial", Font.BOLD, 18));
        headerLabel.setForeground(Color.WHITE);
        headerPanel.add(headerLabel);
        dialog.add(headerPanel, BorderLayout.NORTH);
