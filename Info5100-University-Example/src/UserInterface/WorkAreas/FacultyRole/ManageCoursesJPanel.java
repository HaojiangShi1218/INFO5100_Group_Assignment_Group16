...
public class ManageCoursesJPanel extends JPanel {
    ...
    public ManageCoursesJPanel(Department department, UserAccount userAccount, JPanel cardPanel) {
        this.department = department;
        this.userAccount = userAccount;
        this.cardPanel = cardPanel;
        
        faculty = department.getFacultydirectory().findTeachingFaculty(this.userAccount.getPersonId());
//        if (faculty == null) {
...
//        }
    ...
    private void viewCourseDetails() {
        ...
        CourseDetailJPanel detailPanel = new CourseDetailJPanel(department, userAccount, selectedAssignment, cardPanel);
    ...
    private void toggleEnrollment() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, 
            "Course: " + course.getCOurseNumber() + " - " + course.getName() + "\n" +
