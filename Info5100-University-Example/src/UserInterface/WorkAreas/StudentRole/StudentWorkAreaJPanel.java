...
public class StudentWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public StudentWorkAreaJPanel(JPanel mainWorkArea, StudentProfile studentProfile) {
        initComponents();
    ...
    private void btnCourseWorkIdentifyResourceAssetsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCourseWorkIdentifyResourceAssetsActionPerformed
        CourseworkManagementJPanel courseworkPanel = new CourseworkManagementJPanel(mainWorkArea, studentProfile);
        mainWorkArea.add("CourseworkManagementJPanel", courseworkPanel);
        CardLayout layout = (CardLayout) mainWorkArea.getLayout();
        layout.show(mainWorkArea, "CourseworkManagementJPanel");
    }//GEN-LAST:event_btnCourseWorkIdentifyResourceAssetsActionPerformed

    private void btnManageProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageProfileActionPerformed
        // TODO add your handling code here:
        ProfileManagementJPanel profileManagementPanel = new ProfileManagementJPanel(mainWorkArea, studentProfile);
        mainWorkArea.add("ManageProfileJPanel", profileManagementPanel);
        CardLayout layout = (CardLayout) mainWorkArea.getLayout();
        layout.show(mainWorkArea, "ManageProfileJPanel");
    ...
    private void btnGraduationAuditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGraduationAuditActionPerformed
        // TODO add your handling code here:
        GraduationAuditJPanel gradAuditPanel = new GraduationAuditJPanel(mainWorkArea, studentProfile);
        mainWorkArea.add("GraduationAuditJPanel", gradAuditPanel);
        CardLayout layout = (CardLayout) mainWorkArea.getLayout();
        layout.show(mainWorkArea, "GraduationAuditJPanel");
    }//GEN-LAST:event_btnGraduationAuditActionPerformed

    private void btnRegistrationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrationActionPerformed
        // TODO add your handling code here:
        RegistrationJPanel regPanel = new RegistrationJPanel(mainWorkArea, studentProfile);
        mainWorkArea.add("RegistrationJPanel", regPanel);
        CardLayout layout = (CardLayout) mainWorkArea.getLayout();
        layout.show(mainWorkArea, "RegistrationJPanel");
    ...
    private void btnTranscriptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTranscriptActionPerformed
        // TODO add your handling code here:
        TranscriptReviewJPanel transcriptPanel = new TranscriptReviewJPanel(mainWorkArea, studentProfile);
        mainWorkArea.add("TranscriptJPanel", transcriptPanel);
        CardLayout layout = (CardLayout) mainWorkArea.getLayout();
        layout.show(mainWorkArea, "TranscriptJPanel");
